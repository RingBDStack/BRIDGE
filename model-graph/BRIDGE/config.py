...
def get_args():
    ...
    parser.add_argument("--l2_coef", type=float, default=0, help="pre_weight_decay")
    parser.add_argument(
    ...
    parser.add_argument(
        "--downstreamlr", type=float, default=0.001, help="downstreamlr"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--model_path",
        type=str,
        default="Photo_2024-12-31_15-18-55.pkl",
        help="downprompt",
    )
    parser.add_argument(
